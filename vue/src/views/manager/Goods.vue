<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter the product name" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="Product picture" show-overflow-tooltip>
        ...
        <el-table-column prop="num" label="Remaining amount"></el-table-column>
    ...
    <el-dialog title="Product Information" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="num" label="Quantity">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          {required: true, message: 'Input product name', trigger: 'blur'},
        ],
        price: [
          {required: true, message: 'Input product price', trigger: 'blur'},
        ],
        num: [
          {required: true, message: 'Input product quantity', trigger: 'blur'},
        ]
      },
      ids: []
    }
