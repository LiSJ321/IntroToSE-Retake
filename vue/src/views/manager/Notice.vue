<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter the title to query" style="width: 200px" v-model="title"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="user" label="Announcer"></el-table-column>
        ...
        <el-table-column label="operate" width="180" align="center">
          <template v-slot="scope">
            ...
            <el-button plain type="danger" v-if="user.role === 'ADMIN'"size="mini" @click=del(scope.row.id)>Delete</el-button>
          </template>
        </el-table-column>
      </el-table>
