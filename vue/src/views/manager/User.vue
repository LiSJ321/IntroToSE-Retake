<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter username to query" style="width: 200px" v-model="username"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="yourname"></el-table-column>
    ...
    <el-dialog title="Admin" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="yourname" prop="name">
          <el-input v-model="form.name" placeholder="yourname"></el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="save">Conform</el-button>
      </div>
    </el-dialog>
